...
import static base.CrudOperation.putBrandsListResponse;

public class BrandsListTestCases {
    ...
    public void responseBrandsPutMethod() {
        ...
        ResponseBody body = putBrandsListResponse().getBody(); //use to print response body
